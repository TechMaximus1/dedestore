...
export default function Register() {
    ...
    //Capturing Error ....used to set the error and the error response after upload
    ...
    // const {firstname,lastname, email, phone, password, cPassword, username, userRole} = formInput;
